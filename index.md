...
Developing this ePortfolio and completing my computer science program has helped me clearly define my strengths, professional values, and career direction. My strongest areas are building practical software that balances usability, data integrity, and maintainability. Across coursework and enhancement projects, I learned to approach software as a full lifecycle process: requirements, implementation, testing, iteration, and communication. One of the most formative courses in this development was CS230, where I designed a complete Software Design Document for a web-based game. This included an executive summary, functional and non-functional requirements, design constraints, domain modeling, system architecture views, and technical recommendations. Translating UML diagrams into working code reinforced the connection between abstract system design and practical implementation. That experience strengthened my ability to think structurally before writing code.This process has prepared me to enter the field as a more employable developer who can contribute technically and collaborate effectively.
...
In CS330 – Computer Graphics and Visualization, I strengthened my C++ foundation by building and rendering 3D objects using OpenGL. This course required careful handling of transformations, lighting models, and spatial reasoning. Developing interactive 3D scenes improved my understanding of memory management, performance considerations, and mathematical precision in graphics programming. It was both technically demanding and rewarding, reinforcing my confidence in low-level system interaction and problem-solving under constraints.

In **software engineering and database design**, I built and enhanced applications with clear separation of concerns between UI, business logic, and persistence. The weight tracking artifact demonstrates this with Android/Kotlin components and SQLite-backed data operations for user and weight-entry management. Beyond the artifact itself, my recent work on making the Weight tracking app wearOS compatible expanded this competency through MVVM architecture, Room-based data modeling, repository patterns, and incremental feature delivery. Together, these examples show readiness to design systems that are maintainable and evolvable.
